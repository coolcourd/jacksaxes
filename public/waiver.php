...
$required_fields = ['first-name', 'last-name', 'age', 'address', 'city', 'zip', 'phone', 'emergency', 'date', 'email', 'sig'];
...
// $sql = "INSERT INTO waivers (email, waiver) VALUES ('$obj->email', '$email_body')";
// if (!$mysqli->query($sql)) {
